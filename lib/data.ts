...
export const TEAMS: Team[] = [
  // Grupo A
  { flag:'🇲🇽', name:'México',          slug:'mexico',          group:'A', confederation:'CONCACAF' },
  { flag:'🇿🇦', name:'Sudáfrica',       slug:'sudafrica',       group:'A', confederation:'CAF' },
  { flag:'🇰🇷', name:'Corea del Sur',   slug:'corea-del-sur',   group:'A', confederation:'AFC' },
  { flag:'🇨🇿', name:'Rep. Checa',      slug:'rep-checa',       group:'A', confederation:'UEFA' },
  // Grupo B
  { flag:'🇨🇦', name:'Canadá',          slug:'canada',          group:'B', confederation:'CONCACAF' },
  { flag:'🇧🇦', name:'Bosnia y Herz.',  slug:'bosnia',          group:'B', confederation:'UEFA' },
  { flag:'🇨🇭', name:'Suiza',           slug:'suiza',           group:'B', confederation:'UEFA' },
  { flag:'🇶🇦', name:'Qatar',           slug:'qatar',           group:'B', confederation:'AFC' },
  // Grupo C
  { flag:'🇧🇷', name:'Brasil',          slug:'brasil',          group:'C', confederation:'CONMEBOL' },
  { flag:'🇲🇦', name:'Marruecos',       slug:'marruecos',       group:'C', confederation:'CAF' },
  { flag:'🇭🇹', name:'Haití',           slug:'haiti',           group:'C', confederation:'CONCACAF' },
  { flag:'🏴󠁧󠁢󠁳󠁣󠁴󠁿', name:'Escocia',          slug:'escocia',         group:'C', confederation:'UEFA' },
  // Grupo D
  { flag:'🇺🇸', name:'Estados Unidos',  slug:'estados-unidos',  group:'D', confederation:'CONCACAF' },
  { flag:'🇵🇾', name:'Paraguay',        slug:'paraguay',        group:'D', confederation:'CONMEBOL' },
  { flag:'🇦🇺', name:'Australia',       slug:'australia',       group:'D', confederation:'AFC' },
  { flag:'🇹🇷', name:'Turquía',         slug:'turquia',         group:'D', confederation:'UEFA' },
  // Grupo E
  { flag:'🇩🇪', name:'Alemania',        slug:'alemania',        group:'E', confederation:'UEFA' },
  { flag:'🇨🇼', name:'Curazao',         slug:'curazao',         group:'E', confederation:'CONCACAF' },
  { flag:'🇨🇮', name:'Costa de Marfil', slug:'costa-de-marfil', group:'E', confederation:'CAF' },
  { flag:'🇪🇨', name:'Ecuador',         slug:'ecuador',         group:'E', confederation:'CONMEBOL' },
  // Grupo F
  { flag:'🇳🇱', name:'Países Bajos',    slug:'paises-bajos',    group:'F', confederation:'UEFA' },
  { flag:'🇯🇵', name:'Japón',           slug:'japon',           group:'F', confederation:'AFC' },
  { flag:'🇸🇪', name:'Suecia',          slug:'suecia',          group:'F', confederation:'UEFA' },
  { flag:'🇹🇳', name:'Túnez',           slug:'tunez',           group:'F', confederation:'CAF' },
  // Grupo G
  { flag:'🇧🇪', name:'Bélgica',         slug:'belgica',         group:'G', confederation:'UEFA' },
  { flag:'🇪🇬', name:'Egipto',          slug:'egipto',          group:'G', confederation:'CAF' },
  { flag:'🇮🇷', name:'Irán',            slug:'iran',            group:'G', confederation:'AFC' },
  { flag:'🇳🇿', name:'Nueva Zelanda',   slug:'nueva-zelanda',   group:'G', confederation:'OFC' },
  // Grupo H
  { flag:'🇪🇸', name:'España',          slug:'espana',          group:'H', confederation:'UEFA' },
  { flag:'🇨🇻', name:'Cabo Verde',      slug:'cabo-verde',      group:'H', confederation:'CAF' },
  { flag:'🇸🇦', name:'Arabia Saudí',    slug:'arabia-saudi',    group:'H', confederation:'AFC' },
  { flag:'🇺🇾', name:'Uruguay',         slug:'uruguay',         group:'H', confederation:'CONMEBOL' },
  // Grupo I
  { flag:'🇫🇷', name:'Francia',         slug:'francia',         group:'I', confederation:'UEFA' },
  { flag:'🇸🇳', name:'Senegal',         slug:'senegal',         group:'I', confederation:'CAF' },
  { flag:'🇮🇶', name:'Irak',            slug:'irak',            group:'I', confederation:'AFC' },
  { flag:'🇳🇴', name:'Noruega',         slug:'noruega',         group:'I', confederation:'UEFA' },
  // Grupo J
  { flag:'🇦🇷', name:'Argentina',       slug:'argentina',       group:'J', confederation:'CONMEBOL', isChampion:true,
  ...
  { flag:'🇩🇿', name:'Argelia',         slug:'argelia',         group:'J', confederation:'CAF' },
  { flag:'🇦🇹', name:'Austria',         slug:'austria',         group:'J', confederation:'UEFA' },
  { flag:'🇯🇴', name:'Jordania',        slug:'jordania',        group:'J', confederation:'AFC' },
  // Grupo K
  { flag:'🇵🇹', name:'Portugal',        slug:'portugal',        group:'K', confederation:'UEFA' },
  { flag:'🇨🇩', name:'RD Congo',        slug:'rd-congo',        group:'K', confederation:'CAF' },
  { flag:'🇨🇴', name:'Colombia',        slug:'colombia',        group:'K', confederation:'CONMEBOL' },
  { flag:'🇸🇮', name:'Eslovenia',       slug:'eslovenia',       group:'K', confederation:'UEFA' },
  // Grupo L
  { flag:'🏴󠁧󠁢󠁥󠁮󠁧󠁿', name:'Inglaterra',       slug:'inglaterra',      group:'L', confederation:'UEFA' },
  { flag:'🇭🇷', name:'Croacia',         slug:'croacia',         group:'L', confederation:'UEFA' },
  { flag:'🇬🇭', name:'Ghana',           slug:'ghana',           group:'L', confederation:'CAF' },
  { flag:'🇵🇦', name:'Panamá',          slug:'panama',          group:'L', confederation:'CONCACAF' },
]
...
export const GROUPS: Group[] = 'ABCDEFGHIJKL'.split('').map(letter => ({
  ...
  teams: TEAMS.filter(t => t.group === letter).map(t => ({
    flag: t.flag, name: t.name, slug: t.slug,
  })),
}))
...
function makeRef(name: string): import('@/types').TeamRef {
  ...
  return { flag: t.flag, name: t.name, slug: t.slug }
}
...
// ─── NOTICIAS ────────────────────────────────────────────────────────────────
// Estructura lista para CMS: agregar campo `source: 'cms' | 'static'` en el futuro
// y reemplazar este array por un fetch a Contentful / Sanity / cualquier headless CMS
...
export const NEWS: NewsArticle[] = [
  {
    ...
    excerpt: 'La albiceleste llega como gran favorita al Mundial que se juega en suelo americano. El análisis del equipo de Scaloni.',
  ...
  },
  {
    ...
    excerpt: 'Argentina, Francia, Brasil, España e Inglaterra lideran los pronósticos. ¿Quién tiene más chances?',
    body: `Las casas de apuestas tienen su veredicto: Argentina, Francia, Brasil, España e Inglaterra son los cinco principales candidatos al título del Mundial 2026.\n\n**Argentina** lidera como campeona defensora. **Francia** tiene el plantel más talentoso de Europa. **Brasil** busca romper el maleficio que la aleja de la copa desde 2002. **España** llega con el mejor fútbol colectivo. **Inglaterra** confía en que por fin "viene a casa".\n\nEl formato de 48 equipos agrega incertidumbre: hay más partidos, más posibilidades de sorpresas, y el desgaste físico es un factor nuevo que todos los candidatos deben considerar.`,
    date: '13 jun 2026',
    emoji: '🏆',
    featured: false,
    relatedTeamSlugs: ['argentina', 'francia', 'brasil', 'espana', 'inglaterra'],
  },
  {
    slug: 'mundial-48-equipos-el-mas-ambicioso',
    tag: 'Historia',
    headline: 'Por qué el Mundial de 48 equipos es el más ambicioso de la historia',
    excerpt: 'Por primera vez en la historia, 48 selecciones compiten por la copa. Tres países sede, 16 estadios y 104 partidos.',
    body: `El Mundial 2026 es un torneo histórico en varios sentidos. Por primera vez, 48 selecciones participan en la Copa del Mundo, lo que supone un salto significativo respecto a los 32 equipos de ediciones anteriores.\n\nTres países sede —Estados Unidos, México y Canadá— albergan 104 partidos en 16 estadios durante 39 días de competencia. Es, sin duda, el Mundial más ambicioso logísticamente de la historia del fútbol.\n\nEl nuevo formato incluye 12 grupos de 4 equipos, donde clasifican los dos primeros de cada grupo y los ocho mejores terceros, totalizando 32 equipos para la fase eliminatoria de 16avos de final.`,
    date: '12 jun 2026',
    emoji: '📖',
    featured: false,
    relatedTeamSlugs: [],
  },
  {
    ...
    excerpt: 'El estadio de los Giants y los Jets albergará la final del 19 de julio. Capacidad para 82.500 espectadores.',
    body: `El MetLife Stadium de East Rutherford, Nueva Jersey —en el área metropolitana de Nueva York— será el escenario de la gran final del Mundial 2026 el 19 de julio.\n\nCon capacidad para 82.500 espectadores, el estadio que alberga a los Giants y Jets de la NFL se convertirá en el centro del mundo futbolístico durante 90 minutos.\n\nNueva York es la ciudad más poblada de Estados Unidos y uno de los centros culturales más importantes del planeta. Que la final del primer Mundial de 48 equipos se juegue allí le da una dimensión histórica especial al torneo.`,
    date: '11 jun 2026',
    emoji: '🏟',
    featured: false,
    relatedTeamSlugs: [],
